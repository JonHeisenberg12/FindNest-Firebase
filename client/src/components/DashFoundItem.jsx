...
import { AiOutlineSearch, AiOutlineCalendar, AiOutlineClose } from "react-icons/ai";
              ...
              <div className="flex justify-between">
                ...
                <span
                  className={`text-xs px-2 py-1 rounded-full uppercase font-semibold ${
                    item.status.toLowerCase() === "claimed" ? "bg-green-500 text-white" : "bg-red-800 text-white"
                  }`}
                >
                  {item.status.toLowerCase() === "claimed" ? "Claimed" : "Unclaimed"}
                </span>
              </div>
